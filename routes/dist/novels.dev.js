...
var novelCtl = require('../controller/novel');

router.prefix('/novels'); // 小说接口
...
router.get('/allBooks', novelCtl.AllBooksAPI); // 搜索

router.get('/search', novelCtl.SearchAPI); // 分类

router.get('/type', novelCtl.TypeAPI); // 删除

router.get('/delBook', novelCtl.DeleteBookAPI); //添加

router.post('/addBook', novelCtl.AddBookAPI); //修改
