...
// 电影数据接口
router.get('/movies', userCtl.moviesAPI)
...
router.get('/allBooks', userCtl.AllBooksAPI)

// 搜索
router.get('/search', userCtl.SearchAPI)

// 分类
router.get('/type', userCtl.TypeAPI)

// 删除
router.get('/delBook', userCtl.DeleteBookAPI)
